...
class StockTestModel implements IReminder
{
    /**
     * @return string[]
     */
    ...
    /**
     * @var StockTestMessageModel[]
     */
    private $StockTestMessageList = [];
    /**
     * @return StockTestMessageModel[]
     */
    public function getData()
    {
        $stockList = [];
        foreach ($this->getBasicData()  as $data) {
            $ref = new ReflectionClass('IReminder\IMessage\StockTestMessageModel');
            $this->StockTestMessageList[] = $ref->newInstanceArgs([$data]);
        }
        return $this->StockTestMessageList;
    }
